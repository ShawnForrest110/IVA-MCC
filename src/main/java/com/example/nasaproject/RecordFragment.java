...
public class RecordFragment extends Fragment {
    ...
    private void setupMediaRecorder() {
        ...
        try {
            ...
            Toast toast = Toast.makeText(getContext().getApplicationContext(), "Error", Toast.LENGTH_SHORT);
            toast.show();
        }
    ...
    private void requestPermission() {
        try {
            ...
            Log.e("Error ", e.toString());
            Toast toast = Toast.makeText(getContext().getApplicationContext(), "Error writing", Toast.LENGTH_SHORT);
            toast.show();
        }
    }
