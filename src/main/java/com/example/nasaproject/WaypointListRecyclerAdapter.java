...
public class WaypointListRecyclerAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        waypointRowHolder.waypointName.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Log.i("Waypoint Row", "Activating waypoint " + waypointList.get(position).id);
                WaypointManagerActivity s = (WaypointManagerActivity)context;
                s.setActiveWaypoint(position);
                return false;
            }
        });
    }
